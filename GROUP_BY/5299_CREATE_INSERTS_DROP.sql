...
--extra inserts gia ta erotimata tis ergasias 4

INSERT INTO PHONE VALUES(100000000,6930000321);
INSERT INTO PHONE VALUES(200000000,6930004321);
INSERT INTO VEHICLE VALUES('ZZZ9999','RED',1300,130,0,'CAR');
UPDATE VEHICLECAT SET VehicleCount = VehicleCount + 1
    WHERE Name='CAR';
    
INSERT INTO VEHICLE VALUES('AZA9999','RED',1300,130,0,'BICYCLE');
UPDATE VEHICLECAT SET VehicleCount = VehicleCount + 1
    WHERE Name='BICYCLE';    
...
INSERT INTO CUSTOMER VALUES(220000001,'AK27622','IWANNOU','GEWRGIA',TO_DATE('07/06/2020', 'DD/MM/YYYY'));
INSERT INTO CUSTOMER VALUES(330000002,'AK34333','PAYLOY','MARKOS',TO_DATE('10/01/2021', 'DD/MM/YYYY'));
INSERT INTO CUSTOMER VALUES(440000005,'AK41144','KWNSTANTINIDHS','MAKIS',TO_DATE('08/01/2021', 'DD/MM/YYYY'));    
INSERT INTO CUSTOMER VALUES(760000001,'AK23822','IWANNOU','ELENA',TO_DATE('07/06/2020', 'DD/MM/YYYY'));
INSERT INTO CUSTOMER VALUES(620000002,'AK72333','PAYLOY','MARIOS',TO_DATE('10/01/2021', 'DD/MM/YYYY'));
INSERT INTO CUSTOMER VALUES(340000005,'AK44564','FILIPPIDIS','TASOS',TO_DATE('08/01/2021', 'DD/MM/YYYY')); 

INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('01/07/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('02/07/2021 11:00','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('03/08/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('04/08/2021','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('05/08/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('06/08/2021','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('07/08/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('08/08/2021','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('07/07/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('08/07/2021 11:00','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('09/07/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('10/07/2021 11:00','DD/MM/YYYY HH24/MI'));
INSERT INTO RENTING VALUES(200000000,'AZA9999',TO_DATE('11/07/2021 11:30','DD/MM/YYYY HH24/MI'),TO_DATE('12/07/2021 11:00','DD/MM/YYYY HH24/MI'));
UPDATE vehicle SET vrenttimes = vrenttimes + 7
    WHERE vplatenumber='AZA9999';
